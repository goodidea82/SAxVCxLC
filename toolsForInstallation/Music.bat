...
REM See: http://unix.stackexchange.com/questions/136371/how-to-download-a-folder-from-google-drive-using-terminal

REM REM Example
REM if not exist "%fromDir%\music\CLEO\CLEO_SOUND\Static.mp3" (
REM     if not exist "%fromDir%\music\CLEO\CLEO_SOUND\Static.7z" (
REM	        toolsForInstallation\wget.exe --no-check-certificate  "https://drive.google.com/open?id=0Bys8vEqMtLu-REN2dlAxSEFrS0k" -O Static.7z
REM	    timeout /t 1
...
REM unzip mp3 files
set thisDir=%CD%
cd SAxVCxLC_source\music\CLEO\CLEO_SOUND
..\..\..\..\toolsForInstallation\7z\7z.exe e -pSAxVCxLC *.7z
cd VC
..\..\..\..\..\toolsForInstallation\7z\7z.exe e -pSAxVCxLC *.7z
cd ..\LC
..\..\..\..\..\toolsForInstallation\7z\7z.exe e -pSAxVCxLC *.7z
